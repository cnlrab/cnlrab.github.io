...
# ============================================================
SHEET_ID = "1_JjXEiieNpS9QsC_UrB_H5lpmIMqPLM3-m6us6oA8TY"

# 탭별 CSV URL
EMP_DATA_URL = f"https://docs.google.com/spreadsheets/d/{SHEET_ID}/gviz/tq?tqx=out:csv&sheet=emp_data"
SCHEDULE_DATA_URL = f"https://docs.google.com/spreadsheets/d/{SHEET_ID}/gviz/tq?tqx=out:csv&sheet=calendar_data"
...
<head>
    ...
    <title>주간 업무 현황 - cnlrab</title>

    <!-- SEO 메타 태그 -->
    <meta name="description" content="cnlrab 주간 업무 및 출장 현황표입니다. 연구원들의 출장, 외근, 사내근무 일정을 확인할 수 있습니다.">
    <meta name="keywords" content="cnlrab, cnlrab, 업무현황, 출장현황, 연구소일정">
    <meta name="author" content="cnlrab">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://www.cnlrab.co.kr/s1.html">

    <!-- Open Graph -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="주간 업무 현황 - cnlrab">
    <meta property="og:description" content="cnlrab 주간 업무 및 출장 현황표">
    <meta property="og:url" content="https://www.cnlrab.co.kr/s1.html">
    <meta property="og:locale" content="ko_KR">
    <meta property="og:site_name" content="cnlrab">
    <style>
        /* 기본 스타일 설정 - 다크모드 */
        *, *::before, *::after {{
